						...
						<div class="col-md-7 col-sm-7">
							<form action="<?=site_url('daftar/do_daftar');?>" class="form-horizontal form-without-legend" role="form" method="POST">
								...
								<div class="form-group">
									...
									<div class="col-lg-8">
										<select class="form-control select2me" name="maestro">
											<option value="">Pilih Maestro...</option>
											<option value="Bertha">Bertha</option>
											<option value="Didik Nini Thowok">Didik Nini Thowok</option>
											<option value="Dindon">Dindon</option>
											<option value="Djaduk Ferianto">Djaduk Ferianto</option>
											<option value="I Nyoman Nuarta">I Nyoman Nuarta</option>
											<option value="Julianti Lakshmi Parani">Julianti Lakshmi Parani</option>
											<option value="Nasirun">Nasirun</option>
											<option value="Purwacaraka">Purwacaraka</option>
											<option value="Tan Deseng">Tan Deseng</option>
											<option value="Udjo Ngalagena">Udjo Ngalagena</option>
										</select>
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-4 control-label" for="email">Username / Alamat E-mail<span class="require">*</span></label>
									<div class="col-lg-8">
										<input type="text" class="form-control" name="email_siswa" id="email_siswa" required="required">
										<span class="help-block">
											Masukkan Username / Alamat E-mail </span>
									</div>
								</div>
								<div class="form-group">
